    ...
    >
        <div class="mx-auto flex-grow p-10 w-full py-10 relative mb-2 z-10">
            ...
            >
                ...
                <div
                    id="mobile-menu"
                    class="hidden md:hidden bg-white/5 backdrop-blur-lg border-white/50 shadow-glow text-white p-2 radial-gradient mt-2 mr-8"
                >
                    <nav
                        class="flex flex-col space-y-4 text-base font-semibold p-4"
                        id="mobile-nav-links"
                    >
                        <a
                            href="{{ route('homepage') }}"
