    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 justify-items-center items-center w-full p-4" id="contacts">
        ...
        <div class="flex flex-col text-white items-center md:items-start justify-center">
            <div class="flex gap-4 text-6xl font-bold mb-5">
                <img src="{{ asset('icon.png') }}" alt="logo" class="w-16" />
                Ramsfit
            </div>
            Stay connected—join us on social media and discover stories waiting to unfold.
            <div class="flex flex-row gap-6 mt-6">
                <a href="https://twitter.com/elonmusk" target="_blank" rel="noopener noreferrer" aria-label="Visit our Twitter profile">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="w-8 mt-1">
                ...
                <a href="https://www.instagram.com/sisforbrilliance_/" target="_blank" rel="noopener noreferrer" aria-label="Visit our Instagram profile">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="w-8">
                ...
                <a href="https://www.facebook.com/Facebook" target="_blank" rel="noopener noreferrer" aria-label="Visit our Facebook profile">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="w-7 mt-1">
